...
import './navbar.css'
import '../style.css'
import Logo from '../../assets/img/ic-logo.svg'
...
// import icFiles from '../../assets/img/ic_files'
        ...
        <div className="navbar">
            <div className="container">
                ...
                <div className="navbar__tabs">
                    ...
                    <Switch>
                        <IconButton image={icVideochatSelected}/>
                    </Switch> :  
                    <Switch>
                        <NavLink to="/videochat">
                            <IconButton image={icVideochat}/>
                        </NavLink>
                    </Switch>}

                    {currentPage == 'FILES' ?
                    <Switch>
                        <IconButton image={icFilesSelected}/>
                    </Switch> :  
                    <Switch>
                        <NavLink to="/files">
                            <IconButton image={icFiles}/>
                        </NavLink>
                    </Switch>}
            
                    {!isAuth && <div className="navbar__login"><NavLink to="/login">Войти</NavLink></div> }
                    {/* <object type="image/svg+xml" data={icFiles} class="ic_button_img"></object>    */}
